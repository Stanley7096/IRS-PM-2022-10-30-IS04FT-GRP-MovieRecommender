...
def get_conn():
    conn = pymysql.connect(host='127.0.0.1', port=3306, user='root', passwd='root', db='MovieData', charset='utf8mb4')
    return conn
...
class ItemBasedCF(object):
    ...
    def recommend(self, user):
        ...
        matrix2.clear()
        rank = {}
        # 注意users_resulttable表所有字段一定要保持1 userid 2 imbdid 3 rating 4 id的顺序
